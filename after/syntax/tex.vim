...
" \mathcal characters
    ...
    syn match texStatement '\\quad' contained conceal cchar=                 " space
    syn match texStatement '\\qquad' contained conceal cchar=                " space
    "syn match texStatement '\\\[' contained conceal cchar=⟦
    "syn match texStatement '\\\]' contained conceal cchar=⟧
    ...
    syn match texMathSymbol '\\qquad' contained conceal cchar=          " space
